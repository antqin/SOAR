...
open class CustomDetectionActivityKt : BaseActivity() {

    var visionManagerWasInit = false
    private lateinit var paint: Paint

    // VisionEventsListener handles events from Vision SDK on background thread.
    val visionEventsListener = object : VisionEventsListener {
