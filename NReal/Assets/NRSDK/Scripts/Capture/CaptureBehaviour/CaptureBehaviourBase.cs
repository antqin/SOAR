...
namespace NRKernal.Record
{
    ...
    public class CaptureBehaviourBase : MonoBehaviour, IFrameConsumer
    {
        ...
        public void SetCameraMask(int mask)
        {
            ...
            // NRSessionManager.Instance.NRHMDPoseTracker.GetHeadPoseByTimeInUnityWorld(ref head_pose, timestamp); 
            // CaptureCamera.cullingMask = NRSessionManager.Instance.Camera.main.cullingMask; 
        }
